...
// -ldflags="-X go.pact.im/x/third_party/github.com/lucas-clemente/quic-go/qlog.quicGoVersion=foobar"
...
func init() {
	...
	for _, d := range info.Deps {
		if d.Path == "go.pact.im/x/third_party/github.com/lucas-clemente/quic-go" {
