...
import (
	...
	"go.pact.im/x/third_party/github.com/lucas-clemente/quic-go/interop/http09"
	"go.pact.im/x/third_party/github.com/lucas-clemente/quic-go/interop/utils"
	"go.pact.im/x/third_party/github.com/lucas-clemente/quic-go/qlog"
)
